...
class PrettyCronTest(unittest.TestCase):
    def test_yearly(self):
        assert prettify("0 0 1 1 *") == "At 00:00 on the 1st of January"

    def test_one_day_in_month(self):
        assert prettify("0 0 1 * *") == "At 00:00 on the 1st of every month"

    def test_one_day_in_month_2nd(self):
        assert prettify("0 0 2 * *") == "At 00:00 on the 2nd of every month"

    def test_one_day_in_month_11th(self):
        assert prettify("0 0 11 * *") == "At 00:00 on the 11th of every month"

    def test_one_day_in_month_21st(self):
        assert prettify("0 0 21 * *") == "At 00:00 on the 21st of every month"

    def test_every_day_in_month(self):
        assert prettify("12 15 * 1 *") == "At 15:12 every day in January"

    def test_every_specific_day_in_month(self):
        assert prettify("0 0 * 1 1") == "At 00:00 on every Monday in January"

    def test_weekly(self):
        assert prettify("0 0 * * 0") == "At 00:00 every Sunday"
    ...
    def test_daily(self):
        assert prettify("0 0 * * *") == "At 00:00 every day"
    ...
    def test_continuous(self):
        assert prettify("* * * * *") == "Every minute of every day"
    ...
    def test_nonsense_unchanged(self):
        assert prettify('Lalalala') == 'Lalalala'
