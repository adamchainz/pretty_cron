...
class PrettyCronTest(unittest.TestCase):
    ...
    def test_every_specific_two_day_in_month(self):
        assert (
            pc("0 0 * 1 1,2") ==
            "At 00:00 on every Monday and Tuesday in January"
        )

    def test_every_specific_three_day_in_month(self):
        assert (
            pc("0 0 * 1 1,2,3") ==
    ...
    def test_every_specific_more_days_in_months_and_then_more(self):
        assert (
    ...
    def test_every_specific_two_day_in_months_and_weekly(self):
        assert (
            pc("0 0 1,23 1,2 1") ==
    ...
    def test_every_specific_two_day_in_months_and_twice_week(self):
        assert (
            pc("0 0 1,23 1,2 1,4") ==
            "At 00:00 on the 1st and 23rd of January and February and on "
    ...
    def test_every_specific_two_day_in_months_and_three_day_week(self):
        assert (
    ...
    def test_every_specific_several_days_in_months_and_weekly(self):
        assert (
